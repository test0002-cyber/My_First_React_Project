...
const API_BASE = (window as any).REACT_APP_API_BASE || 'http://localhost:4000'
...
export async function scheduleReport(payload: any) {
...
export async function sendReportNow(payload: any) {
...
export async function sendViaChannel(payload: any) {
...
export async function generateReport(payload: { type: string; payload?: any }) {
